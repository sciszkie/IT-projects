...
class MyTopo(Topo):
    def __init__(self):
        ...
        link_s1s4 = self.addLink(s1, s4, delay='2.85ms', bw=800)
        link_s2s5 = self.addLink(s2, s5, delay='1.61ms', bw=800)
        link_s2s6 = self.addLink(s2, s6, delay='1.43ms', bw=800)
        link_s3s7 = self.addLink(s3, s7, delay='2.09ms', bw=800)
        link_s3s8 = self.addLink(s3, s8, delay='2.47ms', bw=800)
        link_s8s9 = self.addLink(s8, s9, delay='1.95ms', bw=800)
        link_s8s10 = self.addLink(s8, s10, delay='1.56ms',bw=800)

        self.addLink(h1, s1, delay='0.1ms', bw=)
        self.addLink(h2, s2, delay='0.1ms', bw=10)
        self.addLink(h3, s3, delay='0.1ms', bw=800)
        self.addLink(h4, s4, delay='0.1ms', bw=800)
        self.addLink(h5, s5, delay='0.1ms', bw=800)
        self.addLink(h6, s6, delay='0.1ms', bw=800)
        self.addLink(h7, s7, delay='0.1ms', bw=800)
        self.addLink(h8, s8, delay='0.1ms', bw=800)
        self.addLink(h9, s9, delay='0.1ms', bw=800)
        self.addLink(h10, s10, delay='0.1ms', bw=800)
